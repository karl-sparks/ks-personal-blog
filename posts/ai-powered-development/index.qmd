...
- Developing a multi-agent model to enhance the AI's capabilities the tools and data provided to it, possibly leveraging [Microsoft's Autogen Python package](https://www.microsoft.com/en-us/research/blog/autogen-enabling-next-generation-large-language-model-applications/)

- Finally, integrating my original AI resume builder as additional features.
